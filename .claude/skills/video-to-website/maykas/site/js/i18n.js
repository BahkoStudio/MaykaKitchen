...
(function () {
  ...
  const T = {
    sv: {
      ...
      'event.std.b1':   'Inträde till hela eftermiddagen',
      'event.std.b2':   'Matlagning, berättelser och frågestund',
      'event.std.b3':   'Provsmakning av maten',
      'event.vip.name': 'VIP',
      'event.vip.b1':   'Allt som ingår i Standard',
      'event.vip.b2':   'Signerad kokbok',
      'event.vip.b3':   'Prioriterad sittplats',
      'event.vip.b4':   'Träffa Mayka och ta bilder',
      'event.btn':      'Köp biljett →',
      'event.note':     'Biljetter säljs via Billetto',
      /* SOCIALA KANALER */
      'social.label': 'Följ mig',
      'social.title': 'Nya recept varje vecka – <em>direkt i flödet</em>',
      'social.sub':   'Matlagning, vardagstips och det som händer bakom kulisserna. Välj den kanal du gillar bäst.',
      /* SAMARBETE */
      'collab.i1':  'Kampanjer och sponsrat innehåll',
      'collab.i2':  'Receptutveckling för varumärken',
      'collab.i3':  'Matfoto och video',
      'collab.i4':  'Event, matlagningsshower och föreläsningar',
    ...
    en: {
      ...
      'event.currency': 'SEK',
      'event.std.name': 'Standard',
      'event.std.b1':   'Entry to the whole afternoon',
      'event.std.b2':   'Cooking, stories and a Q&amp;A',
      'event.std.b3':   'Tasting of the food',
      'event.vip.name': 'VIP',
      'event.vip.b1':   'Everything in Standard',
      'event.vip.b2':   'Signed cookbook',
      'event.vip.b3':   'Priority seating',
      'event.vip.b4':   'Meet Mayka and take photos',
      'event.btn':      'Buy ticket →',
      'event.note':     'Tickets are sold via Billetto',
      /* SOCIAL CHANNELS */
      'social.label': 'Follow me',
      'social.title': 'New recipes every week – <em>straight to your feed</em>',
      'social.sub':   'Cooking, everyday tips and what happens behind the scenes. Pick the channel you like best.',
      /* COLLABORATIONS */
      'collab.i1':  'Campaigns and sponsored content',
      'collab.i2':  'Recipe development for brands',
      'collab.i3':  'Food photography and video',
      'collab.i4':  'Events, cooking shows and talks',
